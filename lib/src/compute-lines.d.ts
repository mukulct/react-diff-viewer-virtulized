 ...
 */
declare const computeLineInformation: (oldString: string | JSON, newString: string | JSON, disableWordDiff: false, lineCompareMethod: string, linesOffset: 0, showLines?: string[]) => ComputedLineInformation;
