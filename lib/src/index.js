...
class DiffViewer extends React.Component {
    constructor(props) {
        ...
        this.renderSplitView = ({ left, right }, index, styles) => {
            ...
            _jsxs(_Fragment, { children: [this.renderLine(left.lineNumber, left.type, LineNumberPrefix.LEFT, left.value), this.renderLine(right.lineNumber, right.type, LineNumberPrefix.RIGHT, right.value)] })
            // </tr>
            );
        };
        /**
